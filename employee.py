...
class employeeClass:
    def __init__(self, root):
        ...
        # Corrected: Combobox for search options
        ...
        # Corrected: Entry for search text
        ...
        txt_dob = Entry(self.root,textvariable=self.var_dob,font=("goudy old style", 15), bg="lightyellow").place(x=500, y=190)
        ...
        txt_pass = Entry(self.root,textvariable=self.var_pass,font=("goudy old style", 15), bg="lightyellow").place(x=500, y=230)
        ...
        txt_salary = Entry(self.root,textvariable=self.var_salary,font=("goudy old style", 15), bg="lightyellow").place(x=600, y=270)
        ...
        self.EmployeeTable=ttk.Treeview(emp_frame,column=("employeeid","Name","Email","gender","contact","dob","doj","pass","utype","address","salary"),yscrollcommand=scrolly.set,xscrollcommand=scrollx.set)
        scrollx.pack(side=BOTTOM,fill=X)
        scrolly.pack(side=RIGHT,fill=Y)
        scrollx.config(command=self.EmployeeTable.xview)
        scrolly.config(command=self.EmployeeTable.yview)
        self.EmployeeTable.heading("employeeid",text="Employee ID")
...
#====================================================================
    ...
    def add(self):
        ...
        try:
            if self.var_emp_id.get()=="":
                ...
                cur.execute("Select * from employee where employeeid =?",(self.var_emp_id.get(),))
                row=cur.fetchone()
                if row!=None:
                     messagebox.showerror("error","this employee id is already assigned,try different employee id")
                     return
                else:
                    cur.execute("insert into employee (employeeid, Name, Email, gender, contact, dob, doj, pass, utype, address, salary) values (?,?,?,?,?,?,?,?,?,?,?)",
                                                (self.var_emp_id.get(),
                                                self.var_name.get(),
                                                self.var_email.get(),
                                                self.var_gender.get(),
                                                ...
                                                self.var_dob.get(),   # Corrected dob instead of dop
                                                self.var_doj.get(),
    ...
    def get_data(self,ev):  
        ...
        self.var_dob.set(row[5]),   # Corrected dob instead of dop
        ...
        try:
            if self.var_emp_id.get()=="":
                ...
                if row==None:
                    ...
                    cur.execute("Update employee set Name=?, Email=?, gender=?, contact=?, dob=?, doj=?, pass=?, utype=?, address=?, salary=? where employeeid=?",(
        ...
        try:
            if self.var_emp_id.get()=="":
                ...
                if row==None:
                    ...
                    if op==True:
                        cur.execute("delete from employee where employeeid=?",(self.var_emp_id.get(),))
                        con.commit()
    ...
    def clear(self):
        ...
        self.var_dob.set(""),   # Corrected dob instead of dop
        self.var_doj.set(""),
