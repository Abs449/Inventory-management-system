...
class categoryClass:
    def __init__(self,root):
        ...
        #----------------- images ---------------------
        self.im1=Image.open("C:/Users/Abhiram Chintalapati/Desktop/coding/dbmsproject/images/cat.jpg")
        self.im1=self.im1.resize((500,250))
        self.im1=ImageTk.PhotoImage(self.im1)
        self.lbl_im1=Label(self.root,image=self.im1,bd=2,relief=RAISED)
        self.lbl_im1.place(x=50,y=220)

        self.im2=Image.open("C:/Users/Abhiram Chintalapati/Desktop/coding/dbmsproject/images/category.jpg")
